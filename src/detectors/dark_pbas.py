"""Dark sample-based background detector inspired by PBAS."""
...
def sample_background_mask(
    ...
    dark_threshold = max(6, round(threshold * 0.5))
    ...
    for index, pixel in enumerate(current):
        ...
        mask.append(matches < min_matches and (background_level - pixel) > dark_threshold)
